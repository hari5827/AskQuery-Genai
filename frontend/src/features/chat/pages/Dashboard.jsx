          ...
          <footer className="border-t border-white/5 bg-[#090909] p-5">
            ...
            >
              <input
                ...
                disabled={isLoading}
                className="flex-1 rounded-full border border-white/10 bg-[#111111] px-6 py-3 text-base outline-none transition focus:border-red-600 placeholder:text-zinc-500 disabled:opacity-50"
              />

              <button
                type="submit"
                disabled={!chatInput.trim() || isLoading}
                className="rounded-full bg-gradient-to-r from-red-700 to-red-600 px-6 py-3 font-semibold transition hover:from-red-600 hover:to-red-500 disabled:cursor-not-allowed disabled:opacity-40"
              >
                Send
              </button>
            </form>
